return {
    ...
    config = function()
        ...
        ts_config.setup({
            ...
            ensure_installed = {"bash","csv","go","php","rust","vim", "vimdoc", "lua", "java", "javascript", "typescript", "html", "css", "json", "tsx", "markdown", "markdown_inline", "gitignore", "python", "erlang","yaml","kotlin"},
